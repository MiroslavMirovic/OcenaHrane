...
class MealTableViewController: UITableViewController {
    ...
    private func loadSempleMeals() {
        ...
        guard let meal1 = Meal(name: "Piletina", photo: photo1, rating: 4) else {
            fatalError("Unable to instantiate meal1")
        }
        guard let meal2 = Meal(name: "Pizza", photo: photo2, rating: 5) else {
            fatalError("Unable to instantiate meal2")
        }
        guard let meal3 = Meal(name: "Ramstek", photo: photo3, rating: 3) else {
            fatalError("Unable to instantiate meal3")
        }
        guard let meal4 = Meal(name: "Riba", photo: photo4, rating: 2) else {
            fatalError("Unable to instantiate meal4")
        }
        guard let meal5 = Meal(name: "Šnicla", photo: photo5, rating: 1) else {
